...
const installedPackage = resolve(fixture, "node_modules/@orc-tools/orc-design-system");
...
const declaredTarball = resolve(
  fixture,
  fixturePackageJson.dependencies["@orc-tools/orc-design-system"].replace(/^file:/u, ""),
);
